...
def test_operator_selection(my_map, starts, goals):
    ...
    g = 0
    big_F = h + g
    operators, next_big_F = new_osf.select_operators(agent_locs, big_F, h, g)
...
def test_new_children(my_map, starts, goals):
    ...
    g = 0
    big_F = h + g
    children, next_big_F = new_osf.get_children_and_next_F(agent_locs, big_F, h, g)
